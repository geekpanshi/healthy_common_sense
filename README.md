...
3. 体脂率（PBF）：男性，肥胖 PBF ≥ 25%，超重 18% ≤ PBF < 25%；女性，肥胖 PBF ≥ 30%，超重：20% ≤ PBF < 30%。`体脂率（PBF）=1.2×BMI+0.23×年龄 -5.4-10.8×性别（男为 1，女为 0）`。
4. 腰围身高比（WHtR）：男性肥胖，WHtR ≥ 0.50；女性肥胖，WHtR ≥ 0.56。`腰围身高比（WHtR）=腰围/身高`。

或者，满足以下 3 个及其以上（代谢综合征）：

1. 血压（BP）：收缩压 ≥ 130 mmHg 和/或舒张压 ≥ 85 mmHg;
2. 甘油三酯（TG）：甘油三酯 ≥ 1.7 mmol/L;
3. 高密度脂蛋白胆固醇（HDL）：男性 ≤ 1.04 mmol/L，女性 ≤ 1.3 mmol/L；
4. 空腹血糖（FBG）：空腹血糖 ≥ 5.6 mmol/L；
5. 腰围（WC）：男性 ≥ 90 cm，女性 ≥ 80 cm；或者，腰臀比（WHR）：男性 ≥ 0.90，女性 ≥ 0.85。

![代谢综合征自我判断](/健康医学常识/常识-代谢综合征的表现三个及以上.png)
